    ...
    <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h1 class="display-4 text-under">
                <img src="images/cart-simple.png" alt="cart" style="padding-right: 15px;">My Cart
              </h1>
              <p class="lead">Stuff chosen by you
              </p>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      quis, possimus officia esse sequi sit necessitatibus ullam libero quasi velit nulla aliquid, animi eaque. Excepturi
                      velit fugit nihil obcaecati minus non soluta neque cum accusantium magni, perferendis nesciunt provident doloremque
                      consequatur recusandae at quisquam alias praesentium, inventore odit eius unde est natus? Magni dolor sequi praesentium
                      asperiores odit molestiae, atque magnam eius dicta deleniti repellendus, iste porro recusandae, tempore a aspernatur
                      quod laborum nulla aperiam? Ab quaerat sed eius laborum at vero maxime aliquid deleniti nobis, blanditiis voluptate
                      officia id dicta, maiores porro inventore.<br><br>
                      <button type="button" class="btn btn-outline-primary">Save for Later</button>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Doloremque temporibus, rerum mollitia debitis obcaecati suscipit
                      quis, possimus officia esse sequi sit necessitatibus ullam libero quasi velit nulla aliquid, animi eaque. Excepturi velit
                      fugit nihil obcaecati minus non soluta neque cum accusantium magni, perferendis nesciunt provident doloremque consequatur
                      recusandae at quisquam alias praesentium, inventore odit eius unde est natus? Magni dolor sequi praesentium asperiores
                      odit molestiae, atque magnam eius dicta deleniti repellendus, iste porro recusandae, tempore a aspernatur quod laborum
                      nulla aperiam? Ab quaerat sed eius laborum at vero maxime aliquid deleniti nobis, blanditiis voluptate officia id dicta,
                      maiores porro inventore.
                      <br>
                      <br>
                      <button type="button" class="btn btn-outline-primary">Save for Later</button>
                      <button type="button" class="btn btn-outline-danger">Remove Item</button>
        ...
        <div class="col-lg-2" style="padding: 0px 5px;">
          <h1 class="display-4 text-under" style="margin:-5px;">
            Details
          </h1><br>
          <p class="h2">
            <a href="#">Subtotal:</a>
            ...
            <button type="button" class="btn btn-outline-primary btn-lg btn-block">Proceed to Checkout</button>
            <button type="button" class="btn btn-outline-danger btn-lg btn-block">Empty Cart</button>
            <button class="btn btn-outline-info btn-lg btn-block" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false"
              aria-controls="collapseExample">
              EMI Eligibility
            </button>
            <div class="collapse" id="collapseExample">
              <div class="card card-body">
                These items are eligible for EMI with valid credit card. <a href="#">More Details</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container mt-5 mb-4 text-center text-md-left">
            <div class="row mt-3">
              <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
                ...
                <p>BuyM8 is an electronic commerce company headquartered in Bengaluru, India. It was founded in October 2007 by Yash
                  Dave and Huzefa MH.</p>
                </div>
